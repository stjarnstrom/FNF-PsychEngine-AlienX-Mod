...
class ShipGlowParticle extends FlxSprite
{
	...
	public function new(x:Float, y:Float, color:FlxColor)
	{
		...
		loadGraphic(Paths.image('ship/particle'));
...
class ShipGlowGradient extends FlxSprite
{
	...
	public function new(x:Float, y:Float)
	{
		...
		loadGraphic(Paths.image('ship/gradient'));
		antialiasing = ClientPrefs.globalAntialiasing;
